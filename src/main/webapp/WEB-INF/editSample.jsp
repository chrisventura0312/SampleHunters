...
<body>
    ...
    <div class="container mt-4">
        <h1 class="mb-4">Edit Sample</h1>
        
        <form:form method="post" action="/samples/${sample.id}/edit" modelAttribute="sample">
            <input type="hidden" id="id" name="id" value="${sample.id}" />
            ...
            <a href="/samples/${sample.id}/delete" class="btn btn-danger">Delete</a>
        </form:form>
    </div>
</body>
</html>
